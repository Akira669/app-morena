				...
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>" id="account-form" method="post" class="form-horizontal myaccount" role="form">
					...
					<div class="form-group">
						<div class="col-sm-offset-4 col-sm-8">
							<button type="submit" class="btn btn-warning" id="submit_btn" data-loading-text="Cambiando contraseña...."><span class="glyphicon glyphicon-alert"></span> Cambiar Contraseña</button>
						</div>
					</div>
				</form>
		</div>
