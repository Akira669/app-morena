...
class Cl_User{
	...
	public function login( array $data ){
		if( !empty( $data ) ){
			...
			$query = "	SELECT claveElector, nombreUsuario, email,passwd,rol
						FROM users 
						where email = '$email' 
						and passwd = '$password' ";
			...
			if( $count == 1){
				...
				$_SESSION['claveElector'] = $data['claveElector'];
	...
	public function account( array $data )
	{
		if( !empty( $data ) ){
			...
			$password = md5( $password );
			$query = "UPDATE users SET passwd = '$password' WHERE user_id = '$user_id'";
